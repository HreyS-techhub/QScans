...
function currentMenuItem() {
    ...
    $(".navbar-nav .menu-items a").each(function() {
        t($(this).attr("href")) == t(e) && $(this).closest(".nav-item").addClass("active")
    })
}

function mobileMenuToggle() {
    $(window).width() < 992 && $(".has-menu > a").on("click", function(e) {
...
function stickyNav(e) {
    ...
    window.addEventListener("scroll", function(o) {
        ...
        i > 400 ? ($(e).css({
            height: t + "px"
        }), a.addClass("stick")) : a.hasClass("stick") && a.removeClass("stick")
    })
}
